...
//            }
//        };
//        actionBar.addTab(actionBar.newTab().setText("熱門").setTabListener(tabListener));
//        actionBar.addTab(actionBar.newTab().setText("景點").setTabListener(tabListener));
//        actionBar.addTab(actionBar.newTab().setText("美食").setTabListener(tabListener));
//    }
